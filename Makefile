...
clean:
	...
	@docker volume rm -f credpal-fx_redisinsight_data credpal-fx_tempo_data credpal-fx_prometheus_data credpal-fx_grafana_data credpal-fx_loki_data credpal-fx_credpalfx_postgres_data credpal-fx_credpalfx_redis_data >/dev/null 2>&1 || true
